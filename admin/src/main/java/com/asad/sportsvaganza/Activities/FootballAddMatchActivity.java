...
public class FootballAddMatchActivity extends AppCompatActivity {
    TimePicker timePicker;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_football_add_match);
        ...
        Intent intent = new Intent(FootballAddMatchActivity.this, FootballMainActivity.class);
